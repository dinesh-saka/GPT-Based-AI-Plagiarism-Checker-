...
st.title("Large Language Model Text Analysis")
...
if text_area is not None:
    if st.button("Analyze"):
        ...
        with col2:
            ...
            st.warning("Disclaimer: AI plagiarism detectors are helpful but not flawless, so they should be used alongside human judgment for accurate results.")
